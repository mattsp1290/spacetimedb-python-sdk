...
class TestCompressionManager:
    ...
    def test_initialization_with_config(self):
        ...
        assert manager.config.security_config.max_compression_ratio == 10.0
    ...
    def test_decompression_size_limit(self):
        ...
        config = CompressionConfig(security_config=small_limit_config)
        manager = CompressionManager(config=config)
        
        # Compress data larger than the limit
        large_data = b"Large data " * 50
        compressed, _ = manager.compress(large_data, CompressionType.GZIP)
    ...
    def test_security_validator_integration(self):
        ...
        compressed, _ = manager.compress(self.test_data)
        ...
        manager.config.security_config.validate_decompressed_data = True
    ...
    def test_unsupported_compression_type(self):
        ...
        with patch('spacetimedb_sdk.compression.compression_manager.LZ4_AVAILABLE', False):
    ...
    def test_compression_info(self):
        ...
        assert info["security"]["max_compression_ratio"] == 10.0
    ...
    def test_performance_benchmarks(self):
        ...
        compressed, _ = manager.compress(self.large_data, CompressionType.GZIP)
